...
public class Exam01Controller {	
	...
	@RequestMapping("/home")//이 앞에 context root(http://localhost:8080/webapp/)생략
	public String home() {	
	...
	@RequestMapping("/exam01/boardlist")//이 앞에 context root(http://localhost:8080/webapp/)생략
	public String getBoardList(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("list", list); //jsp에서 사용할수있도록 넘김
				
				//뷰 이름 리턴 / 앞에/없는이유 = prefix가 /까지 붙어서
